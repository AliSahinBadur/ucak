  ...
  const documents = [
    {
      ...
      subtitle: "Detay stok regalleri statik analiz raporu",
      work: "BIG-E",
      topic: "Dayanım",
      year: "2025",
      person: "Ali Şahin",
      type: "PDF",
      confidence: 96,
      path: "V:\\RAPORLAR\\BIG-E\\2025-BIG-E-DUR-01\\2025-BIG-E-DUR-01.pdf",
    ...
    },
    {
      ...
      subtitle: "Konfor parkuru test raporu",
      work: "BIG-E",
      topic: "Konfor",
      year: "2025",
      person: "Ece Demir",
      type: "PDF",
      confidence: 93,
      path: "V:\\RAPORLAR\\BIG-E\\2025-BIG-E-TEST-13\\2025-BIG-E-TEST-13.pdf",
    ...
    },
    {
      ...
      type: "DOCX",
      confidence: 91,
      path: "V:\\RAPORLAR\\BIG-E\\TERMAL\\2023-BIG-E-THERM-03.docx",
    ...
    },
    {
      ...
      type: "PPTX",
      confidence: 89,
      path: "V:\\RAPORLAR\\CITIBUS\\DAYANIM\\2024-CITIBUS-DUR-04.pptx",
    ...
    },
    {
      ...
      type: "PDF",
      confidence: 95,
      path: "V:\\RAPORLAR\\CITIPORT\\NVH\\2026-CITIPORT-NVH-02.pdf",
    ...
    {
      id: "13m-weight",
      title: "13M_Ağırlıkdağılımı_Raporu",
      ...
      type: "DOCX",
      confidence: 68,
      path: "V:\\RAPORLAR\\13M\\HESAPLAR\\13M_Ağırlıkdağılımı_Raporu.docx",
    ...
    return `
      <section class="mx-app" aria-label="Etkileşimli kurumsal hafıza ağacı">
        <header class="mx-topbar">
          <div class="mx-brand">
            <img class="mx-brand-logo" src="/raporhub-landing/assets/raporhub-symbol.png" alt="">
            <span class="mx-brand-copy"><strong>RaporHub</strong><span>Kurumsal Hafıza</span></span>
          </div>
          <div class="mx-path-control">
            <label>Kök klasör</label>
            <input type="text" value="V:\\RAPORLAR" aria-label="Taranacak kök klasör yolu" data-memory-path>
